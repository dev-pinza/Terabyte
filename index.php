...
?>
        ...
        <section class="banner-section banner-three">
            ...
            background-image: url(images/main-slider/banner-bg-shape-3.png);
          "></div>
                ...
                <div class="row clearfix">
                    ...
                    <div class="left-col col-lg-6 col-md-12 col-sm-12">
                        <div class="inner">
                            <div class="sec-title">
                                <h2>
                                    We are standout <br />experts in business
                                    <span class="dot">.</span>
                                </h2>
                                <div class="lower-text">
                                    We believe that success is achieved through a highly
                                    collaborative interaction, so that we can work together to
                                    identify and evaluate opportunities beyond your current
                                    operations.
                                </div>
                            </div>
                            <div class="counter">
                ...
                <div class="row clearfix">
                    ...
                    <div class="left-col col-lg-6 col-md-12 col-sm-12">
                        <div class="inner">
                            <div class="sec-title">
                                <h2>
                                    We are always here to help you<span class="dot">.</span>
                                </h2>
                            </div>
                            <div class="text">
