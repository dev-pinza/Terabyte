(function ($) {
  ...
  $("#styleOptions .color-default").on("click", function () {
    ...
    let bannerBg = "images/main-slider/banner-bg.jpg";
    ...
    Cookies.set("banner-bg", bannerBg, {
      expires: 365,
      path: "/"
    });
  });
  ...
  $("#styleOptions .color-2").on("click", function () {
    ...
    let bannerBg = "images/colors/color-2/main-slider/banner-bg.jpg";
  ...
  $("#styleOptions .color-3").on("click", function () {
    ...
    let bannerBg = "images/colors/color-3/main-slider/banner-bg.jpg";
  ...
  $("#styleOptions .color-4").on("click", function () {
    ...
    let bannerBg = "images/colors/color-4/main-slider/banner-bg.jpg";
  ...
  $("#styleOptions .color-5").on("click", function () {
    ...
    let bannerBg = "images/colors/color-5/main-slider/banner-bg.jpg";
  ...
  $("#styleOptions .color-6").on("click", function () {
    ...
    let bannerBg = "images/colors/color-6/main-slider/banner-bg.jpg";
