                ...
                <div class="row clearfix">
                    ...
                    <div class="content-side col-lg-8 col-md-12 col-sm-12">
                        <div class="blog-posts">
                            <!--News Block-->
                            <?php
                            $query1 = "SELECT * FROM `blog_post` ORDER BY id DESC LIMIT 50";
                        ...
                        while($row1 = mysqli_fetch_array($result1, MYSQLI_ASSOC)) {?>
                            <div class="news-block-two">
                                <div class="inner-box">
                                    <div class="image-box">
                                        <a href="blog_single.php?view=<?php echo $row1["id"]?>"><img src="ams/blog_post/<?php echo $row1["visual"] ?>" alt="" /></a>
                                        <?php
                                        $type = $row1["type"];
                                        if ($type != "Image") {
                                            ?>
                                    ...
                                    <div class="lower-box">
                                        ...
                                        <div class="link-box">
                                            <a class="theme-btn" href="blog_single.php?view=<?php echo $row1["id"];?>">Read More</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
