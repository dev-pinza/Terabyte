...
<!-- ============================================================== -->
            ...
            <div class="page-content container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <h4 class="mb-3">Total Pending Ad Summary</h4>
                        <!-- row -->
                        <div class="row">
                            <!-- Column -->
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row pt-2 pb-2">
                                            <!-- Column -->
                                            <div class="col pr-0">
                                                <h1 class="font-light">5/10</h1>
                                                <h6 class="text-muted">Total Client/Active</h6></div>
                                            <!-- Column -->
                                    ...
                                    <div class="card-body">
                                        <div class="row pt-2 pb-2">
                                            ...
                                            <div class="col pr-0">
                                                ...
                                                <h6 class="text-muted">Total Pending/Active Ads</h6></div>
                                            <!-- Column -->
                                            <div class="col text-right align-self-center">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row pt-2 pb-2">
                                            <!-- Column -->
                                            <div class="col pr-0">
                                                <h1 class="font-light">27%</h1>
                                                <h6 class="text-muted">Total Ad Days</h6></div>
                                            <!-- Column -->
                                            <div class="col text-right align-self-center">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row pt-2 pb-2">
                                            <!-- Column -->
                                            <div class="col pr-0">
                                                <h1 class="font-light">NGN 32k</h1>
                                                <h6 class="text-muted">Total Pending Income</h6></div>
                                            <!-- Column -->
                                            <div class="col text-right align-self-center">
                            ...
                            <div class="el-card-item">
                                ...
                                <div class="d-flex no-block align-items-center">
                                    <div class="ml-3">
                                        ...
                                        <span class="text-muted">Ad description | A  - active | P - close due date</span>
                                    </div>
                                    <div class="ml-auto mr-3">
                                        <button type="button" class="btn btn-success btn-circle">A</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="el-card-item">
                                ...
                                <div class="d-flex no-block align-items-center">
                                    ...
                                    <div class="ml-auto mr-3">
                                        <button type="button" class="btn btn-dark btn-circle">P</button>
                                    </div>
                                </div>
                            </div>
                        </div>
