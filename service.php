                ...
                <div class="row clearfix">
                        ...
                        <div class="inner">
                            <div class="sec-title">
                                ...
                                <div class="lower-text">
                                    ...
                                    service while offering the core business model.
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="service-block col-xl-3 col-lg-6 col-md-6 col-sm-12">
                        <div class="inner-box">
                            ...
                            <h6>
                                <a href="#">seo & content <br />writing</a>
                            </h6>
                        </div>
                    </div>
                    <!--Service Block-->
        ...
        <section class="we-work-section">
            <div class="auto-container">
                <div class="sec-title centered">
                    <h2>Terabyte Core Model <span class="dot">.</span></h2>
                </div>
                <!--Work Tabs-->
                <div class="work-tabs tabs-box">
                    ...
                    <ul class="tab-btns tab-buttons clearfix">
                        <li data-tab="#tab-1" class="tab-btn active-btn">
                            <span>Crowd Advertisement</span>
                        </li>
                        <li data-tab="#tab-2" class="tab-btn">
                            <span>Marketing & Brand Consulting</span>
                        </li>
                        ...
                        <div class="tab active-tab" id="tab-1">
                            <div class="row clearfix">
                                <div class="image-col col-lg-5 col-md-6 col-sm-12">
                                    <div class="inner">
                                        <div class="image">
                                            <img src="img/network-social.jpg" alt="" />
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="tab" id="tab-2">
                            <div class="row clearfix">
                                <div class="image-col col-lg-5 col-md-6 col-sm-12">
                                    <div class="inner">
                                        <div class="image">
                                            <img src="img/growth_text.jpg" alt="" />
                                        </div>
                                    </div>
                                </div>
                                <div class="text-col col-lg-7 col-md-6 col-sm-12">
                                    <div class="inner">
                                        <div class="content">
                                            <div class="text">
                                                <p class="theme_color">
                                                    We Have best marketing strategy you want, your business is always in our heart.
                                                </p>
                                                <div class="link-box">
                        ...
                        <div class="tab" id="tab-3">
                            <div class="row clearfix">
                                <div class="image-col col-lg-5 col-md-6 col-sm-12">
                                    <div class="inner">
                                        <div class="image">
                                            <img src="img/student-laptop.jpg" alt="" />
                                        </div>
                                    </div>
                                </div>
                                <div class="text-col col-lg-7 col-md-6 col-sm-12">
        ...
        <section class="call-to-section-two alternate">
            <div class="auto-container">
                <div class="inner clearfix">
                    <h2>We’re Ready to Market <br />your Business</h2>
                    <div class="link-box">
                        <a class="theme-btn btn-style-two" href="contact.php">
                            <i class="btn-curve"></i>
