                                 ...
                                 <tbody>
                                     <tr>
                                         <td>
                                             ...
                                             <p>Password: $pass</p>
                                             <center>
                                                 <a href='https://thisistera.com/login.php' style='display: inline-block; padding: 11px 30px; margin: 20px 0px 30px; font-size: 15px; color: #fff; background: #008080; border-radius: 60px; text-decoration:none;'>Login</a>
                                             </center>
                                             <center>
                                                 <a href='https://thisistera.com/change_password.php?username=$un' style='display: inline-block; padding: 11px 30px; margin: 20px 0px 30px; font-size: 15px; color: #fff; background: #008080; border-radius: 60px; text-decoration:none;'>Change Password</a>
                                             </center>
